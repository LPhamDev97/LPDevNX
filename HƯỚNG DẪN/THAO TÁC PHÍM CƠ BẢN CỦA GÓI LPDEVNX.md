...
- Mở chạy game cần ép xung > Game mở lên rồi thì mở menu ULTRAHAND (phím - và +) > Chọn EdiZon > Chọn Cheats.
--------------
* TẮT MÁY - RESTART MÁY KHÔNG CẦN NHẤN PHÍM NGUỒN :
- Mở ULTRAHAND (phím - và +) > Nhấn mũi tên sang phải (Joy-con trái) > Dùng các mũi tên lên - xuống để chọn > Bên dưới cùng sẽ có 2 lựa chọn Reboot (Khởi động máy) hoặc Shutdown (Tắt máy).
